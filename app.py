...
def main():
    ...
    st.write(
        'Welcome to the Rice Price Forecasting App! You can view existing rice price data in Ghana and generate forecasts. These predictions are for 50kg bags of Rice in Ghana.')
