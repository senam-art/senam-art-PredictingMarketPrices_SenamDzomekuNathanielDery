...
def main():
    ...
    st.sidebar.markdown("""
        ...
        In this application, you can forecast rice prices for a specified number of months into the future. 
    ...
    st.write(
        'Welcome to the Rice Price Forecasting App! You can view existing rice price data in Ghana and generate forecasts.')
    ...
    if st.sidebar.button('Generate Forecast'):
        with st.spinner('Generating forecast...'):
            ...
            fig_forecast.add_trace(go.Scatter(x=forecast_data['ds'], y=forecast_data['TimeGPT'],
                                              mode='lines+markers',
            ...
            fig_detailed_forecast.add_trace(go.Scatter(x=forecast_data['ds'], y=forecast_data['TimeGPT'],
                                                           mode='lines+markers',
